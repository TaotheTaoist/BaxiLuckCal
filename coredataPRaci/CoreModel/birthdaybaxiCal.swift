...
class birthdaybaxiCal {
    ...
    func evaluateData(year: Int, month: Int, day: Int) {
                ...
                for (key, value) in shoukan {
                    if key == year {
                        if value.contains(day) {
                            print("in shoukan")
                            print(getBaxiMonthTop2(getBaxiyear:getBaxiyear, year: year, thatmonth: month))
                            break
                        }
                        else{
                            print(getBaxiMonthTopJan(getBaxiyear:getBaxiyear, year: year, thatmonth: month))
                        }
                    }
                }
        }
        if month == 2{
                ...
                for (key, value) in haru {
                    if key == year {
                        if value.contains(day) {
                            print("haru")
                            print(getBaxiMonthTopMinus(getBaxiyear:getBaxiyear, year: year, thatmonth: month))
                            break
                        }
                        print(getBaxiMonthTop(getBaxiyear:getBaxiyear, year: year, thatmonth: month))
                    }
                }
