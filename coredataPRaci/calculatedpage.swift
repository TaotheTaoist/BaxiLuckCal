...
//        .background(Image("fbgimage").resizable().frame(width: 1400, height: 1400) .aspectRatio(contentMode: .fit))
        ...
        .onAppear {
            ...
            sCal.chitop(zhi: calcu.evaluateData(year: dateComponents.0, month: dateComponents.1, day: dateComponents.2))
            ...
            sCal.chibotMonth(zhi: calcu.getBaxiMonthbot(month: self.dateComponents.1))
