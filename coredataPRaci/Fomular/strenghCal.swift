...
//        print(woodCount)
        ...
        let newWater = Double(woodCount) / 60.0
        let newWood = Double(woodCount) / 60.0
        let newFire = Double(fireCount) / 60.0
        let newMetal = Double(metalCount) / 60.0
        let newEarth = Double(earthCount) / 60.0
        print(newWood)
    }
//    var yearTop: String
//    init(yearTop: String) {
